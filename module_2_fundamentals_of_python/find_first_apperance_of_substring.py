...
'''
   if y (poor substring) first occurrence greater than x (not substring) first occurrence replace the whole 'not'...'poor' substring with 'good otherwise returns the same as string
'''   
if y > x:  
